...
const ExploreCard = ({ id, imgUrl, title, index, active, handleClick }) => (
  <motion.div
    ...
    } flex items-center justify-center min-w-[170px] min-h-[700px] transition-[flex] duration-75 ease-out-flex cursor-pointer`}
  ...
  >
    ...
    {active !== id ? (
      ...
      <div className='absolute bottom-0 p-8 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-3xl'>
        ...
        <p className='text-normal text-xl leading-5 text-white uppercase'>
          Enter the Metaverse
        </p>
